...
export class QuestionControllerService {
  ...
  /**
   * listQuestionByPageTeacher
   * @param questionQueryRequest questionQueryRequest
   * @returns BaseResponse_Page_Question_ OK
   * @returns any Created
   * @throws ApiError
   */
  public static listQuestionByPageTeacherUsingPost(
    questionQueryRequest: QuestionQueryRequest
  ): CancelablePromise<BaseResponse_Page_Question_ | any> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/question/list/page/teacher",
      body: questionQueryRequest,
      errors: {
        401: `Unauthorized`,
        403: `Forbidden`,
  ...
  public static getQuestionCountUsingGet(): CancelablePromise<BaseResponse_long_> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/question/question/count",
      errors: {
        401: `Unauthorized`,
        403: `Forbidden`,
        404: `Not Found`,
   ...
   * @throws ApiError
   */
  public static getQuestionSubmitCountUsingGet(): CancelablePromise<BaseResponse_long_> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/question/question_submit/count",
      errors: {
        401: `Unauthorized`,
        403: `Forbidden`,
        404: `Not Found`,
  ...
  public static getQuestionSubmitByIdUsingGet(
    ...
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/question/question_submit/{id}",
      path: {
        id: id,
      },
      errors: {
